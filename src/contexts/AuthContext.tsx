...
interface AuthContextType {
  ...
  loading: boolean;
  signUp: (email: string, password: string, fullName: string, role?: 'student' | 'instructor' | 'admin' | 'consultant') => Promise<{ error: Error | null }>;
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const signOut = async () => {
    try {
      ...
      // Clear any lingering supabase auth keys
      try {
